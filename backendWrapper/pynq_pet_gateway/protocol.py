...
class ErrorCode(StrEnum):
    ...
    INVALID_CLIENT_COMMAND = "INVALID_CLIENT_COMMAND"
    CONFIG_VALIDATION_FAILED = "CONFIG_VALIDATION_FAILED"
    AUDIO_FORMAT_UNSUPPORTED = "AUDIO_FORMAT_UNSUPPORTED"
    AUDIO_CHUNK_OUT_OF_ORDER = "AUDIO_CHUNK_OUT_OF_ORDER"
    IMAGE_TOO_LARGE = "IMAGE_TOO_LARGE"
    PAYLOAD_TOO_LARGE = "PAYLOAD_TOO_LARGE"
    SESSION_NOT_READY = "SESSION_NOT_READY"
    TURN_ALREADY_ACTIVE = "TURN_ALREADY_ACTIVE"
    INTERRUPT_WITHOUT_ACTIVE_TURN = "INTERRUPT_WITHOUT_ACTIVE_TURN"
    UPSTREAM_ASR_ERROR = "UPSTREAM_ASR_ERROR"
    UPSTREAM_AGENT_ERROR = "UPSTREAM_AGENT_ERROR"
